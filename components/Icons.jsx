...
export const TelegramIcon = ({ className, ...rest }) => (
    <svg
        ...
        {...rest}
    >
        <path fill="#2CA5E0" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.46.93-4.12 2.73-.39.27-.74.41-1.06.4-.35-.01-1.03-.2-1.53-.36-.61-.2-1.09-.31-1.06-.66.02-.18.27-.37.76-.56 2.97-1.29 4.95-2.14 5.94-2.55 2.82-1.17 3.41-1.38 3.8-1.38.08 0 .27.02.39.1.1.07.13.16.14.24-.01.07.01.19 0 .25z"/>
    </svg>
);
